...
public class DbController {
    ...
    public List<DbDTO> getServerByHostAndDate(@RequestParam(name = "host")  String host, @RequestParam(name = "date")  String date ) throws  Exception{
        log.info("controller getMapping " + host + " , " + date);
        return dbService.getServerByHostAndDate(host, date);
    }
